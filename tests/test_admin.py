...
def test_auth_required__anonymous_cancel(client: Client) -> None:
...
def test_job_list_view__renders_jobs(mock_get_jobs: MagicMock, staff_client: Client) -> None:
...
@patch("django_dagster.admin.client.get_jobs")
def test_job_list_view__connection_error(mock_get_jobs: MagicMock, staff_client: Client
) -> None:
...
@patch("django_dagster.admin.client.get_jobs")
def test_job_list_view__job_name_links_to_detail(mock_get_jobs: MagicMock, staff_client: Client
) -> None:
    mock_get_jobs.return_value = [
...
@patch("django_dagster.admin.client.get_jobs")
def test_job_list_view__sort_by_name(mock_get_jobs: MagicMock, staff_client: Client) -> None:
    mock_get_jobs.return_value = [
...
@patch("django_dagster.admin.client.get_jobs")
def test_job_list_view__dagster_ui_links_shown(mock_get_jobs: MagicMock, staff_client: Client
) -> None:
    mock_get_jobs.return_value = [
        {
            "name": "etl_job",
...
def _trigger_url(job_name: str = "etl_job") -> str:
...
def test_trigger_job_view__get_renders_form(mock_default_config: MagicMock, staff_client: Client
    ...
    resp = staff_client.get(_trigger_url())
...
@patch("django_dagster.admin.client.get_job_default_run_config")
def test_trigger_job_view__get_prefills_default_run_config(mock_default_config: MagicMock, staff_client: Client
) -> None:
...
@patch("django_dagster.admin.client.get_job_default_run_config")
def test_trigger_job_view__get_empty_default_shows_empty_json(mock_default_config: MagicMock, staff_client: Client
) -> None:
    mock_default_config.return_value = {}
...
@patch("django_dagster.admin.client.get_job_default_run_config")
def test_trigger_job_view__get_default_config_error_falls_back(mock_default_config: MagicMock, staff_client: Client
) -> None:
...
def test_trigger_job_view__post_triggers_job(mock_submit: MagicMock, staff_client: Client
) -> None:
...
@patch("django_dagster.admin.client.submit_job")
def test_trigger_job_view__post_redirects_to_run_detail(mock_submit: MagicMock, staff_client: Client
) -> None:
    mock_submit.return_value = "new-run-123"
...
@patch("django_dagster.admin.client.submit_job")
def test_trigger_job_view__post_with_config(mock_submit: MagicMock, staff_client: Client
) -> None:
...
def test_trigger_job_view__post_invalid_json(staff_client: Client) -> None:
    resp = staff_client.post(
        _trigger_url(),
        {"run_config": "{bad json"},
    )
...
def _make_run(status: str = "SUCCESS") -> dict[str, Any]:
    return {
        "runId": "abc12345-def0-1234-5678-abcdef012345",
        "jobName": "etl_job",
        "status": status,
...
def test_run_detail_view__renders_detail(mock_get_run: MagicMock,
    ...
    mock_get_run.return_value = _make_run()
    mock_get_runs.return_value = []
...
def test_run_detail_view__cancel_button_shown_for_running(mock_get_run: MagicMock,
    ...
    mock_get_run.return_value = _make_run(status="STARTED")
    mock_get_runs.return_value = []
...
def test_run_detail_view__reexecute_button_shown_for_failed(mock_get_run: MagicMock,
    ...
    mock_get_run.return_value = _make_run(status="FAILURE")
    mock_get_runs.return_value = []
...
def test_run_detail_view__reexecute_button_shown_for_success(mock_get_run: MagicMock,
    ...
    mock_get_run.return_value = _make_run(status="SUCCESS")
    mock_get_runs.return_value = []
...
def test_cancel_run_view__cancel_success(mock_cancel: MagicMock, staff_client: Client) -> None:
    run_id = "abc12345-def0-1234-5678-abcdef012345"
...
@patch("django_dagster.admin.client.cancel_run")
def test_cancel_run_view__cancel_error(mock_cancel: MagicMock, staff_client: Client) -> None:
...
def test_reexecute_run_view__reexecute_success(mock_reexecute: MagicMock, staff_client: Client
) -> None:
...
@patch("django_dagster.admin.client.reexecute_run")
def test_reexecute_run_view__reexecute_redirects_to_new_run(mock_reexecute: MagicMock, staff_client: Client
) -> None:
    mock_reexecute.return_value = "new-run-id"
...
@patch("django_dagster.admin.client.reexecute_run")
def test_reexecute_run_view__reexecute_error(mock_reexecute: MagicMock, staff_client: Client
) -> None:
...
def test_reexecute_run_view__reexecute_get_redirects(staff_client: Client) -> None:
...
def test_admin_index__dagster_section_with_both_models(staff_client: Client) -> None:
...
def test_admin_index__jobs_no_add_link(staff_client: Client) -> None:
...
@patch("django_dagster.admin.client.get_job_default_run_config")
def test_permissions_disabled__staff_can_trigger_without_explicit_perms(mock_cfg: MagicMock, staff_client: Client
) -> None:
    mock_cfg.return_value = {}
...
@patch("django_dagster.admin.client.cancel_run")
def test_permissions_disabled__staff_can_cancel_without_explicit_perms(mock_cancel: MagicMock, staff_client: Client
) -> None:
